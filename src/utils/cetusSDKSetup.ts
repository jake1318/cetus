...
// Network can be "mainnet", "testnet", or "devnet" – using mainnet here
...
// Create the provider with the updated configuration for Sui mainnet
...
// Initialize the SDK using buildSdk for Cetus on mainnet
